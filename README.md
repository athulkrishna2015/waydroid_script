...
```
git clone https://github.com/casualsnek/waydroid_script](https://github.com/athulkrishna2015/waydroid_script.git
cd waydroid_script
python3 -m venv venv
...
```bash
git clone https://github.com/athulkrishna2015/waydroid_script.git
cd waydroid_script
python3 -m venv venv
venv/bin/pip install -r requirements.txt
# install something
